...
The main objective of this project is to show that I can scrape websites, manipulate, clean, and analyze textual data. For this project, I have used 170 URLs [which you can find on Input.xlsx fille] scraping and extracting textual data. After tokenizing and removing all stop words from the text data. I have calculated 13 parameters for each textual data. These parameters are:
1. Positive score
2. Negative score
3. Polarity score
...
I had written two distinct scripts for this project:
...
• This project is completed with the help of pandas, requests, bs4, nltk, and RegEx packages installed on Python 3.8 and PyCharm IDE. • If you want to see the scrapped text data, you can see after unzipping it from 'textdata.7z'   
